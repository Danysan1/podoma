...
* Tag aggiuntivi associati ai cartelli, dalla colonna "Tags for affected highways" di [Key:traffic_sign](https://wiki.openstreetmap.org/wiki/Key:traffic_sign#Tags_for_affected_highways), per esempio:
