    ...
    if (mode == "init"){
        ...
        if (CONFIG.hasOwnProperty("OVERPASS_URL") && CONFIG.OVERPASS_URL != null && (csvMembers != null || live_enabled)){
            ...
            if [[ "\$missing_features" != "||" ]]; then
                ...
                curl -d @${CONFIG.WORK_DIR}/missing_osm.overpass --retry 10 --retry-max-time 250 -f -o "${CONFIG.WORK_DIR}/missing_osm.xml" -A "Podoma (via curl)" -X POST ${CONFIG.OVERPASS_URL}
